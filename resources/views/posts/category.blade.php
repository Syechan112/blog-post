...
@section('content')
    <div class="container mx-auto px-6 py-8">
        <h2 class="text-2xl font-bold mb-4">Kategori: <span class="text-indigo-500">{{ $category->name }}</span></h2>
        ...
        @foreach ($posts as $post)
            <div class="mt-6 bg-white rounded-lg shadow-md overflow-hidden mb-12">
                <div class="px-6 py-4">
                    ...
                    <p class="text-gray-600 mt-2 md:text-lg text-sm">By
        ...
        @if ($posts->isEmpty())
            <p class="text-gray-500">Belum ada postingan di kategori ini.</p>
        @endif
    </div>
@endsection
